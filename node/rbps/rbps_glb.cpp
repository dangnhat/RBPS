...
void rbps_init(void) {
	...
	/* init queue */
	main2znp_queue_id = CoCreateQueue(main2znp_queue, main2znp_queue_size, EVENT_SORT_TYPE_FIFO);
	znp2main_queue_id = CoCreateQueue(znp2main_queue, znp2main_queue_size, EVENT_SORT_TYPE_FIFO);
}
